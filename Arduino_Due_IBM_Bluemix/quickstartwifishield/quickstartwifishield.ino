...
#define MS_PROXY "quickstart.internetofthings.ibmcloud.com"//"quickstart.messaging.internetofthings.ibmcloud.com"
...
#define MQTT_CLIENTID "d:quickstart:iotsample-arduino:arduino"
